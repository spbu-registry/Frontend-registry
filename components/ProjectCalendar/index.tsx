...
const ProjectCalendar: FC<ProjectCalendarProps> = ({ formDataRef }) => {
    const [Timeline, setTimeline] = useState(formDataRef.current!.projectTimeline);
    ...
    useEffect(() => {
        for (let el of statusBox.current?.childNodes) {
            if (el.textContent == formDataRef.current!.projectTimeline.projectStatus) {
    ...
    function statusChange(e) {
        if (e.target != e.currentTarget) {
            ...
            // сохраняем изменения
            const _ = Object.assign({}, Timeline); _.projectStatus = e.target.textContent; setTimeline(_);
        }
    }
    return (
        <>
            ...
            <div className={styles.dateAdd}>
                ...
                <div>
                    <input
                        ...
                        onChange={e => { const _ = Object.assign({}, Timeline); _.dateAdd = e.target.value; setTimeline(_); }} />
            ...
            <div className={styles.applicationDeadline}>
                ...
                <div>
                    от <input
                        ...
                        onChange={e => { const _ = Object.assign({}, Timeline); _.applicationDeadline.from = e.target.value; setTimeline(_); }} />
                    до <input
                        className={styles.inputField} _ type="date"
                        value={Timeline.applicationDeadline.to}
                        onChange={e => { const _ = Object.assign({}, Timeline); _.applicationDeadline.to = e.target.value; setTimeline(_); }} />
                </div>
            </div>
            <div className={styles.projectImplementationDates}>
                ...
                <div>
                    от <input
                        ...
                        onChange={e => { const _ = Object.assign({}, Timeline); _.projectImplementationDates.from = e.target.value; setTimeline(_); }} />
                    до <input
                        className={styles.inputField}
                        type="date"
                        value={Timeline.projectImplementationDates.to}
                        onChange={e => { const _ = Object.assign({}, Timeline); _.projectImplementationDates.to = e.target.value; setTimeline(_); }} />
                </div>
            </div>
            <div className={styles.projectProtection}>
                ...
                <div>
                    от <input
                        ...
                        onChange={e => { const _ = Object.assign({}, Timeline); _.projectProtection.from = e.target.value; setTimeline(_); }} />
                    до <input
                        className={styles.inputField}
                        type="date"
                        value={Timeline.projectProtection.to}
                        onChange={e => { const _ = Object.assign({}, Timeline); _.projectProtection.to = e.target.value; setTimeline(_); }} />
                </div>
            </div>
            <div className={styles.projectStatus}>
                <div className={styles.align}>Статус проекта:</div>
                <div className={styles.status} onClick={e => statusChange(e)} ref={statusBox}>
