  ...
  return (
    ...
    <div className={styles.InfoAboutCuTuDiInner}>
      <div className={styles.contener}>
        ...
        <div className={styles.box}  onClick={()=>handleClick(1)} onMouseOver={()=>handleMouseOver(1)} onMouseOut={()=>handleMouseOut(1)}>
          <div className={styles.cu} style={ {borderColor :  "#c2333300" ,background: "rgba(167, 197, 189, 0.6)"}}>
            Заказчик  
          </div>
        ...
        <div className={styles.box}  onClick={()=>handleClick(2)} onMouseOver={()=>handleMouseOver(2)} onMouseOut={()=>handleMouseOut(2)}>
          <div className={styles.cu} style={ {borderColor :  "#c2333300" ,background: "#c2333333"}}>
            Куратор
          </div>
        ...
        <div className={styles.box} onClick={()=>handleClick(3)} onMouseOver={()=>handleMouseOver(3)} onMouseOut={()=>handleMouseOut(3)}>
          <div className={styles.cu} style={ {borderColor :  "#c2333300" ,background: "rgba(252, 175, 57, 0.3)"}}>
            Руководитель
          </div>
